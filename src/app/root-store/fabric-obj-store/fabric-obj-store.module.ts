...
import {FabricObjStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([FabricObjStoreEffects]),
	],
	declarations: [],
	providers: [FabricObjStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class FabricObjStoreModule {
}
